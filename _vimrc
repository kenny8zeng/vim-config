...
set foldenable                                        "启用折叠
set foldmethod=marker                                 "indent | syntax | marker 折叠方式
set foldclose=all
...
"  < YouCompleteMe  插件配置 >
" -----------------------------------------------------------------------------
let g:ycm_global_ycm_extra_conf='~/.vim/conf.d/_ycm_extra_conf.py'
